...
<meta property="og:site_name" content="StreamBase.pl - Angielskie publiczne warezy">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Angielskie publiczne warezy">
...
<title property="name">StreamBase.pl - Angielskie publiczne warezy</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$war_ang_pub_data</b>" ?><br> 
<?php echo "$war_ang_pub_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista Angielskich publicznych stron/for z warezami:</font></span></b><br>
<br><font size="5">
	<?php echo "$war_ang_pub_linki" ?>
</div></font></main>
