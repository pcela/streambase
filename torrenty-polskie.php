...
<meta property="og:site_name" content="StreamBase.pl - Polskie torrenty">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Polskie torrenty">
...
<title property="name">StreamBase.pl - Polskie torrenty</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$tor_pl_data</b>" ?><br> 
<?php echo "$tor_pl_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista Polskich katalogów z torrentami:</font></span></b><br>
<br><font size="5">
	<?php echo "$tor_pl_linki" ?>
</div></font></main>
