...
<meta property="og:site_name" content="StreamBase.pl - eBooki/AudioBooki">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - eBooki/AudioBooki">
...
<title property="name">StreamBase.pl - eBooki/AudioBooki</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$ksiazki_data</b>" ?><br>
<?php echo "$ksiazki_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista darmowych stron z AudioBookami (Polskie i zagraniczne):</font></span></b><br>
<br><font size="5">
  <?php echo "$ksiazki_a_linki" ?>
  </font>
</div> <div class="admonition note">
<span style="color: #d8d8f6"><font size="5"><b>Lista darmowych stron z eBookami (Polskie i zagraniczne):</b></font></span></b><br>
<font size="5"><br>
	<?php echo "$ksiazki_e_linki" ?>
</font>
  </div></main>
