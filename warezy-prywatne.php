...
<meta property="og:site_name" content="StreamBase.pl - Polskie prywatne warezy">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Polskie prywatne warezy">
...
<title property="name">StreamBase.pl - Polskie prywatne warezy</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$war_priv_data</b>" ?><br> 
<?php echo "$war_priv_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista Polskich prywatnych stron z warezami:</font></b><br>
<br><font size="5">
	<?php echo "$war_priv_linki" ?>
</div></font></main>
