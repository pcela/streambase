...
<meta property="og:site_name" content="StreamBase.pl - Angielskie torrenty">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Angielskie torrenty">
...
<title property="name">StreamBase.pl - Angielskie torrenty</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$tor_ang_data</b>" ?><br> 
<?php echo "$tor_ang_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista Angielskich katalogów z torrentami:</font></span></b><br>
<br><font size="5">
  <?php echo "$tor_ang_linki" ?>
