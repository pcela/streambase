...
<meta property="og:site_name" content="StreamBase.pl - Przydatne strony dla kinomaniaków">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Przydatne strony dla kinomaniaków">
...
<title property="name">StreamBase.pl - Przydatne strony dla kinomaniaków</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$filmy_narzedzia_data</b>" ?><br> 
<?php echo "$filmy_narzedzia_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista przydatnych stron dla świata filmów i seriali online:</font></span></b><br>
<br><font size="4">
	<?php echo "$filmy_narzedzia_linki" ?>
</div></font></main>
