...
<meta property="og:site_name" content="StreamBase.pl - Przydatne strony do torrentów">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Przydatne strony do torrentów">
...
<title property="name">StreamBase.pl - Przydatne strony do torrentów</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$tor_wiecej_data</b>" ?><br> 
<?php echo "$tor_wiecej_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Przydatne strony i narzędzia dla użytkowników torrentów:</font></span></b><br>
<br><font size="4">
<?php echo "$tor_wiecej_linki_ogolne" ?>
	</div><div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Wyszukiwarki torrentów:<br></font></span></b><br><font size="5">

	<?php echo "$tor_wiecej_linki_wysz" ?>
