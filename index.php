...
<head>
    ...
    <meta name="keywords"
        content="strony z filmami, strony z filmami online, filmy online, seriale online, Telewizja Online, online, filmy za darmo, seriale za darmo, film online, serial online, ranking seriali, najlepsze seriale,  ranking filmów, Popularne filmy">
    <meta name="description"
        content="Najaktualniejsza baza z darmowymi stronami do oglądania filmów i seriali online, i nie tylko!">
    <meta property="og:site_name" content="StreamBase.pl - Twoje źródło rozrywki">
    <meta property="og:url" content="https://www.StreamBase.pl/">
    <meta property="og:title" content="StreamBase.pl - Twoje źródło rozrywki">
    ...
    <link type="text/css" rel="stylesheet"
        href="css/style-index.css?<?php echo date('YmdHis',filemtime('css/style-index.css'));?>">
    <link type="text/css" rel="stylesheet" href="css/logo.css?<?php echo date('YmdHis',filemtime('css/logo.css'));?>">

    <title property="name">StreamBase.pl - Twoje źródło rozrywki</title>
        ...
        <div class="wrapper">
            ...
            <ul class="nav-links">
                ...
                <li>&nbsp;&nbsp;&nbsp;<span style="color: #d8d8f6">&#8901;</span>&nbsp;&nbsp;
                    <a href="./czat-sb">Czat</a>
                </li>

                <li>&nbsp;&nbsp;&nbsp;<span style="color: #d8d8f6">&#8901;</span>&nbsp;&nbsp;
                    <a href="./reklamy">Blokowanie reklam</a>
                </li>
