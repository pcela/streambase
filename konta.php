...
<meta property="og:site_name" content="StreamBase.pl - Konta premium">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Konta premium">
...
<title property="name">StreamBase.pl - Konta premium</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$konta_data</b>" ?><br> 
<?php echo "$konta_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista darmowych for które oferują darmowe konta premium:</font></b><br><br>
<font size="5">

	
	<?php echo "$konta_darmowe_linki" ?>
	
	</div>
	<div class="admonition note">
	<b><span style="color: #d8d8f6"><font size="5">Lista płatnych for które oferują darmowe konta premium:</font></b><br><br>
	
	<?php echo "$konta_platne_linki" ?>
