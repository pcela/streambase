...
<meta property="og:site_name" content="StreamBase.pl - Animowane">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Animowane">
...
<title property="name">StreamBase.pl - Animowane</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$anima_data</b>" ?><br> 
<?php echo "$anima_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista stron z kreskówkami/bajkami/animacjami:</font></span></b><br>
<br><font size="5">

	<?php echo "$anima_bajki_linki" ?>
	
	</div></font>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista stron z anime:</font></span></b><br>
<br><font size="5">

	<?php echo "$anima_anime_linki" ?>
