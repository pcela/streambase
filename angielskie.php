...
<meta property="og:site_name" content="StreamBase.pl - Angielskie strony">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Angielskie strony">
...
<title property="name">StreamBase.pl - Angielskie strony</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$ang_data</b>" ?><br>
<?php echo "$ang_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista darmowych zagranicznych stron z filmami i serialami:</font></span></b><br>
<br><font size="5">
  <?php echo "$ang_linki" ?>
  </font></div></main>
