...
<meta name="description" content="Sport online za darmo / Najaktualniejsza baza z darmowymi stronami do oglądania filmów i seriali online, i nie tylko!">
<meta property="og:site_name" content="StreamBase.pl - Sport online">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - Sport online">
<meta property="og:description" content="Sport online za darmo / Najaktualniejsza baza z darmowymi stronami do oglądania filmów i seriali online, i nie tylko!">

<link rel="icon" href="img/sbfav.png" type="image/x-icon">
<link rel="shortcut icon" href="img/sbfav.png" type="image/x-icon">

<title property="name">StreamBase.pl - Sport online</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$sport_data</b>" ?><br> 
<?php echo "$sport_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista stron które oferują darmowo sport online (też Polski):</font></b><br>
<br><font size="5">
	<?php echo "$sport_linki" ?>
</div></font></main>
