...
<meta property="og:site_name" content="StreamBase.pl - TV online">
<meta property="og:url" content="https://www.streambase.pl/">
<meta property="og:title" content="StreamBase.pl - TV online">
...
<title property="name">StreamBase.pl - TV online</title>
...
<div class="admonition note"><span style="color: #d8d8f6">OSTATNIA AKTUALIZACJA: <?php echo "<b>$tv_data</b>" ?><br> 
<?php echo "$tv_co_zostalo_zmienione" ?></div>
<div class="admonition note">
<b><span style="color: #d8d8f6"><font size="5">Lista stron które oferują darmowo telewizje online (też Polską):</font></b><br>
<span style="font-family: OCR A Std, monospace"><br><font size="5">
<?php echo "$tv_linki" ?>
</div></font></main>
<div class="footer">
